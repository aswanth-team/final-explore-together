...
class AdminViewPackageCommentSheet extends StatefulWidget {
  ...
  const AdminViewPackageCommentSheet({
    super.key,
    required this.packageId,
  });

  @override
  AdminViewPackageCommentSheetState createState() =>
      AdminViewPackageCommentSheetState();
}

class AdminViewPackageCommentSheetState
    extends State<AdminViewPackageCommentSheet> {
